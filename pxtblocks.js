...
(function (pxt) {
    ...
    (function (blocks_6) {
        ...
        function injectToolbox(tb, info, fn, block, showCategories, pnames, filters) {
                ...
                if (cat) {
                    ...
                    if (attr && attr !== "false") {
                        ...
                        for (var i = 0; i < blockElements.length; i++) {
                            ...
                            var bId = b.getAttribute("type");
                            var translatedCatName = pxt.Util.rlf("{id:category}" + name, []);
        ...
        function iconToFieldImage(id) {
            ...
            return new Blockly.FieldImage(url, 56, 56, pxt.Util.isUserLanguageRtl(), '');
        }
