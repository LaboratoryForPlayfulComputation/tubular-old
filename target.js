var pxtTargetBundle = {
    ...
    "appTheme": {
        ...
        "docMenu": [
            {
                "name": "About",
                "path": "/tubular/docs/about"
            },
            {
                "name": "Docs",
                "path": "/tubular/docs/docs"
            }
        ],
    ...
    "apiInfo": {
        "libs/core": {
            "apis": {
                "byQName": {
                    ...
                    "video.setVideo": {
                        "kind": -3,
                        "attributes": {
                            "blockId": "video_set_video",
                            "block": "set video %string",
                            "blockGap": "8",
                            "weight": 98,
                            "blockNamespace": "video",
                            "inBasicCategory": "true",
                            "paramHelp": {
                                "rate": ""
                            },
                            "jsDoc": "Set video using YouTube URL ID",
                            "_def": {
                                "parts": [
                                    {
                                        "kind": "label",
                        ...
                        "pyQName": "video.set_video"
                    },
                    "video.setSpeed": {
                        "kind": -3,
                        "attributes": {
                            "blockId": "video_set_speed",
                            "block": "set speed %rate",
                            "blockGap": "8",
                            "weight": 98,
                            "blockNamespace": "video",
                            "inBasicCategory": "true",
                        ...
                        "pyQName": "video.set_speed"
                    },
                    "video.getSpeed": {
                        "kind": -3,
                        "retType": "number",
                        "attributes": {
                            "blockId": "video_get_speed",
                            "block": "get speed",
                            "blockGap": "8",
                            "weight": 98,
                            "blockNamespace": "video",
                            "inBasicCategory": "true",
                            "jsDoc": "Get video speed",
                            "_def": {
                                "parts": [
                                    {
                                        "kind": "label",
                        ...
                        "parameters": [],
                        "pyQName": "video.get_speed"
                    },
                    "video.isPlaying": {
                        "kind": -3,
                        "retType": "boolean",
                        "attributes": {
                            "blockId": "video_is_playing",
                            "block": "video is playing",
                            "blockGap": "8",
                            "weight": 98,
                            "blockNamespace": "video",
                            "inBasicCategory": "true",
                            "jsDoc": "Determine if the video is playing",
                            "_def": {
                                "parts": [
                                    {
                                        "kind": "label",
                        ...
                        "parameters": [],
                        "pyQName": "video.is_playing"
                    },
                    "video.getCurrentTime": {
                        "kind": -3,
                        "retType": "number",
                        "attributes": {
                            "blockId": "video_current_time",
                            "block": "current time",
                            "blockGap": "8",
                            "weight": 98,
                            "blockNamespace": "video",
                            "inBasicCategory": "true",
                            "jsDoc": "Determine the current time of the video",
                            "_def": {
                                "parts": [
                                    {
                                        "kind": "label",
                        ...
                        "parameters": [],
                        "pyQName": "video.get_current_time"
                    },
                    "video.getDuration": {
                        "kind": -3,
                        "retType": "number",
                        "attributes": {
                            "blockId": "video_duration",
                            "block": "video duration",
                            "blockGap": "8",
                            "weight": 98,
                            "blockNamespace": "video",
                            "inBasicCategory": "true",
                            "jsDoc": "Determine the duration of the video",
                            "_def": {
                                "parts": [
                                    {
                                        "kind": "label",
                        ...
                        "parameters": [],
                        "pyQName": "video.get_duration"
                    },
                    "video.getVolume": {
                        "kind": -3,
                        "retType": "number",
                        "attributes": {
                            "blockId": "video_get_volume",
                            "block": "video volume",
                            "blockGap": "8",
                            "weight": 98,
                            "blockNamespace": "video",
                            "inBasicCategory": "true",
                            "jsDoc": "Get the video's current volume",
                            "_def": {
                                "parts": [
                                    {
                                        "kind": "label",
                        ...
                        "parameters": [],
                        "pyQName": "video.get_volume"
                    },
                    "video.isMuted": {
                        "kind": -3,
                        "retType": "boolean",
                        "attributes": {
                            "blockId": "video_is_muted",
                            "block": "video is muted",
                            "blockGap": "8",
                            "weight": 98,
                            "blockNamespace": "video",
                            "inBasicCategory": "true",
                            "jsDoc": "Determine if the video is muted",
                            "_def": {
                                "parts": [
                                    {
                                        "kind": "label",
                    ...
                    "video.rewind": {
                        ...
                        "attributes": {
                            ...
                            "jsDoc": "Rewind a specific number of seconds",
                            "_def": {
                                "parts": [
                                    {
                                        "kind": "label",
                    ...
                    "video.fastforward": {
                        "kind": -3,
                        "attributes": {
                            "blockId": "video_fastforward",
                            "block": "fast forward %value",
                            "blockGap": "8",
                            "weight": 98,
                            "blockNamespace": "video",
                            "inBasicCategory": "true",
                            ...
                            "jsDoc": "Fast forward a specific number of seconds",
                            "_def": {
                                "parts": [
                                    {
                                        "kind": "label",
                    ...
                    "video.setVolume": {
                        "kind": -3,
                        "attributes": {
                            "blockId": "video_set_volume",
                            "block": "set volume %value",
                            "blockGap": "8",
                            "weight": 98,
                            "blockNamespace": "video",
                            "inBasicCategory": "true",
            ...
            "sha": "4185b38a923dd92ca1af055787d60a902966df3f414e888dc7c208846eae50ad"
        },
        "libs/blocksprj": {
            "apis": {
                "byQName": {}
            },
            "sha": "c74b201960eeb61e66f88e81456048994b5905e2dab93dc0ccc7c7621fa3353a"
        }
    }
}